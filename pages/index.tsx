      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-blue-50">
        ...
        <section className="container mx-auto px-4 py-12 md:py-24">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <form onSubmit={handleSearch} className="bg-white/95 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-pink-100">
              <div className="flex flex-col md:flex-row gap-6 items-end">
                ...
                <div className="flex-1 flex gap-4">
                  <div className="flex-1">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Aged from</label>
                    <div className="relative">
                      <select
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-8 py-3 bg-gradient-to-r from-pink-500 to-pink-600 text-white rounded-xl hover:from-pink-600 hover:to-pink-700 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Featured Profiles</h2>
            ...
            <div className="text-center mt-12">
              <Link href="/profiles" className="inline-block bg-pink-500 text-white px-8 py-3 rounded-xl hover:bg-pink-600 transition duration-300">
                View All Profiles
              </Link>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {testimonials.map((testimonial) => (
                <div
                  key={testimonial.id}
                  className="bg-white rounded-lg shadow-lg p-6 flex flex-col md:flex-row gap-6 items-center"
                >
        ...
        <section className="py-16 bg-gradient-to-r from-pink-500 to-purple-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link
              href="/auth/register"
              className="bg-white text-pink-500 px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-100 transition duration-300 inline-block"
            >
              Sign Up Now
            </Link>
          </div>
